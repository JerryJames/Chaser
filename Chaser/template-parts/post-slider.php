...
// Get cached post ids.
$post_ids = chaser_get_magazine_post_ids( 'post-slider', $theme_options['slider_category'], $theme_options['slider_limit'] );
...
if ( $slider_query->have_posts() ) :
	...
	add_filter( 'excerpt_length', 'chaser_slider_excerpt_length' );
...
<?php
	...
	remove_filter( 'excerpt_length', 'chaser_slider_excerpt_length' );
