...
if ( ! function_exists( 'chaser_default_menu' ) ) :
	/**
	 * Display default page as navigation if no custom menu was set
	 */
	function chaser_default_menu() {
 ...
 * @return array
 */
function chaser_body_classes( $classes ) {
...
add_filter( 'body_class', 'chaser_body_classes' );
...
function chaser_hide_elements() {
	...
	$elements = apply_filters( 'chaser_hide_elements', $elements );
	...
	// Add Custom CSS.
	wp_add_inline_style( 'chaser-stylesheet', $custom_css );
}
add_filter( 'wp_enqueue_scripts', 'chaser_hide_elements', 11 );
 ...
 * @return void
 */
function chaser_retina_logo() {
	// Return early if there is no logo image or option for retina logo is disabled.
	if ( ! has_custom_logo() or false === chaser_get_option( 'retina_logo' ) ) {
		return;
	}
	...
	// Add Custom CSS.
	wp_add_inline_style( 'chaser-stylesheet', $css );
}
add_filter( 'wp_enqueue_scripts', 'chaser_retina_logo', 11 );
 ...
 * @return int
 */
function chaser_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'chaser_excerpt_length' );
 ...
 * @return string
 */
function chaser_excerpt_more( $more_text ) {
...
add_filter( 'excerpt_more', 'chaser_excerpt_more' );


/**
 * Set wrapper start for wooCommerce
 */
function chaser_wrapper_start() {
	echo '<section id="primary" class="content-area">';
	echo '<main id="main" class="site-main" role="main">';
}
remove_action( 'woocommerce_before_main_content', 'woocommerce_output_content_wrapper', 10 );
add_action( 'woocommerce_before_main_content', 'chaser_wrapper_start', 10 );


/**
 * Set wrapper end for wooCommerce
 */
function chaser_wrapper_end() {
	echo '</main><!-- #main -->';
	echo '</section><!-- #primary -->';
}
remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10 );
add_action( 'woocommerce_after_main_content', 'chaser_wrapper_end', 10 );
