...
(function( $ ) {
	...
	function initNavigation( containerClass, naviClass ) {
		...
		(function() {
			...
			menuToggle.on( 'click.chaser_', function() {
		...
		(function() {
			...
			var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false } )
				.append( chaserScreenReaderText.icon )
				.append( $( '<span />', { 'class': 'screen-reader-text', text: chaserScreenReaderText.expand } ) );
			...
			navigation.find( '.current-menu-ancestor > button' )
				...
				.text( chaserScreenReaderText.collapse );
			...
			navigation.find( '.dropdown-toggle' ).click( function( e ) {
				...
				screenReaderSpan.text( screenReaderSpan.text() === chaserScreenReaderText.expand ? chaserScreenReaderText.collapse : chaserScreenReaderText.expand );
			} );
		})();
		...
		(function() {
			...
			function toggleFocusClassTouchScreen() {
				if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
					...
					$( document.body ).on( 'touchstart.chaser_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' )
						.on( 'touchstart.chaser_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' ).unbind( 'touchstart.chaser_' );
				}
			}

			if ( 'ontouchstart' in window ) {
				$( window ).on( 'resize.chaser_', toggleFocusClassTouchScreen );
				toggleFocusClassTouchScreen();
			}

			menuList.find( 'a' ).on( 'focus.chaser_ blur.chaser_', function() {
