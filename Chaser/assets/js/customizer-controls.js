	...
	wp.customize( 'custom_logo', function( setting ) {
		setting.bind( function( value ) { 
			if ( '' !== value ) {
				...
				wp.customize.instance( 'chaser_theme_options[retina_logo]' ).set( false );
			}
		});
		...
		wp.customize.control( 'chaser_theme_options[retina_logo_title]', setupControl );
		wp.customize.control( 'chaser_theme_options[retina_logo]', setupControl );
	} );
