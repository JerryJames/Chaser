...
( function( $ ) {
	...
	// Site Title checkbox.
	wp.customize( 'chaser_theme_options[site_title]', function( value ) {
	...
	wp.customize( 'chaser_theme_options[site_description]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Sidebar Position.
	wp.customize( 'chaser_theme_options[layout]', function( value ) {
		value.bind( function( newval ) {
	...
	// Blog Layout.
	wp.customize( 'chaser_theme_options[post_layout]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'chaser_theme_options[blog_title]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'chaser_theme_options[blog_description]', function( value ) {
		value.bind( function( to ) {
	...
	// Read More textfield.
	wp.customize( 'chaser_theme_options[read_more_text]', function( value ) {
		value.bind( function( to ) {
			$( 'a.more-link' ).text( to );
		} );
	} );
	...
	// Post Date checkbox.
	wp.customize( 'chaser_theme_options[meta_date]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'chaser_theme_options[meta_author]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'chaser_theme_options[meta_category]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Post Tags checkbox.
	wp.customize( 'chaser_theme_options[meta_tags]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'chaser_theme_options[post_navigation]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
